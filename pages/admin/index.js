      ...
      <div className="max-w-3xl mx-auto px-4 py-8 sm:py-10">
        ...
        <div className="space-y-3">
          ...
          >
            ...
            <div className="flex-1">
              <h2 className="font-semibold text-white group-hover:text-amber-300 transition-colors">Bildirim Yönetimi</h2>
              <p className="text-slate-500 text-sm mt-0.5">Kullanıcıların bildirdiği vizyonları incele, karar ver, gerekirse sil.</p>
            </div>
          </Link>
        </div>
      </div>
