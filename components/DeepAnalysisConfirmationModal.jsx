...
export default function DeepAnalysisConfirmationModal({
  ...
  return (
    ...
    >
      <div
        ref={modalRef}
        className="relative w-full max-w-lg max-h-[92dvh] overflow-y-auto overscroll-contain pb-8 rounded-3xl border border-white/10 bg-[#070b14] p-6 shadow-[0_30px_100px_rgba(0,0,0,0.65)] sm:p-8"
