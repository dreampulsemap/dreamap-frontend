...
// update-dream, delete-dream, update-profile ve friends/* route'ları artık
// Authorization: Bearer <token> header'ını zorunlu kılıyor (bkz. bu
// route'lardaki "GÜVENLİK DÜZELTMESİ" yorumları). Bu yardımcı, mevcut
// oturumun access_token'ını { Authorization } şeklinde döner — oturum yoksa
// boş obje döner, o route'lar zaten 401 ile karşılık verir.
